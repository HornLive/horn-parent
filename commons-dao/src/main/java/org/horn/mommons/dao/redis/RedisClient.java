package org.horn.mommons.dao.redis;
...
public class RedisClient {
    ...
    { 
        ...
        config.setMaxIdle(20); // config.setMaxActive(20); 
        config.setMaxIdle(5); 
        config.setMaxWaitMillis(1); //config.setMaxWait(1000l);
...
//		new RedisClient().show();
		...
		Jedis jedis = new Jedis("10.10.0.135", 6379);
		Set<String> keys = jedis.keys("*");
		Set<String> keysnew = jedis.keys("r*");
		System.out.println(keys.size());
		System.out.println(keysnew.size());
